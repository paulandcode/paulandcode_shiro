...
<head>
    ...
    <link rel="stylesheet" href="${jsPath}/jquery-treetable/stylesheets/jquery.treetable.css">
    <link rel="stylesheet" href="${jsPath}/jquery-treetable/stylesheets/jquery.treetable.theme.default.css">
    <style>
        #table th, #table td {
            font-size: 14px;
            padding : 8px;
